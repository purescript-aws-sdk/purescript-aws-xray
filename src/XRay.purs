...
batchGetTraces = Request.request service method  where
    service = Request.ServiceName "XRay"
    method = Request.MethodName "batchGetTraces"
...
getServiceGraph = Request.request service method  where
    service = Request.ServiceName "XRay"
    method = Request.MethodName "getServiceGraph"


-- | <p>Retrieves a service graph for one or more specific trace IDs.</p>
getTraceGraph :: forall eff. GetTraceGraphRequest -> Aff (exception :: EXCEPTION | eff) GetTraceGraphResult
getTraceGraph = Request.request service method  where
    service = Request.ServiceName "XRay"
    method = Request.MethodName "getTraceGraph"
...
getTraceSummaries = Request.request service method  where
    service = Request.ServiceName "XRay"
    method = Request.MethodName "getTraceSummaries"
...
putTelemetryRecords = Request.request service method  where
    service = Request.ServiceName "XRay"
    method = Request.MethodName "putTelemetryRecords"
...
putTraceSegments = Request.request service method  where
    service = Request.ServiceName "XRay"
    method = Request.MethodName "putTraceSegments"
